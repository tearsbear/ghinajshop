  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-color" style="z-index: 2;">
      ...
      <div class="container">
          <div class="row mt-3">
                <?php
                    $nws = mysqli_query($conn, "SELECT * FROM berita WHERE category='news' ORDER BY judul ASC");
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="berita-view.php?id_berita=<?php echo $idn; ?>" class="btn btn-primary text-capitalize">View more</a>
                        </div>
                    </div>
                    <br>
                    </div>
